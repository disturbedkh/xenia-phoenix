...
// Maps Android touch / gamepad events forwarded by WindowedAppActivity into a
// single virtual Xbox 360 controller (user index 0).
class AndroidInputDriver final : public InputDriver {
 public:
  ...
  void OnTouch(float norm_x, float norm_y, bool down);
